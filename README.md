...
Controls: WASD drive, Space double-jumps, E dodges, Shift boosts, C changes camera, and Q uses an optional Power Volley ability; learn boost, jumps, aerial returns, and placement in Rocket Academy, chase the three-round Arcade Cup, complete ten persistent Pilot Record milestones, or play true two-camera local split-screen with P2 on gamepad.
